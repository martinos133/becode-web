/**
 * Potvrdí e-mail používateľa v Supabase (odstráni "Email not confirmed").
 * Spustenie: z priečinka apps/api: node scripts/confirm-user-email.mjs
...
async function main() {
  ...
  if (error) {
    console.error('Chyba pri potvrdení e-mailu:', error.message);
    process.exit(1);
  }
  console.log('E-mail potvrdený pre:', data.user?.email);
}
